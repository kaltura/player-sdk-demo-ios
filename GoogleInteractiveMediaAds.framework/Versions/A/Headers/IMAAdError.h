...
/// The |type| provides information about whether the error occured during
/// ad loading or ad playing.
@property(nonatomic, readonly) IMAErrorType type;

/// The |code| provides more specific information about what error ocurred.
@property(nonatomic, readonly) IMAErrorCode code;

/// The |message| gives a brief description about the error.
